...
media_list = [
    {
        ...
        "file_name": "inbox_2503_b39029e9-6280-4ca9-a820-f69426015d3a.jpg",
...
for media in media_list:
    extension = Path(media['file_name']).suffix
    if extension == '.jpg':
